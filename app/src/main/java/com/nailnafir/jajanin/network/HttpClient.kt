...
import com.nailnafir.jajanin.BuildConfig
import com.nailnafir.jajanin.Jajanin
import com.nailnafir.jajanin.utils.Helpers
...
class HttpClient {
    ...
    private fun buildRetrofitClient() {
        val token = Jajanin.getApp().getToken()
    ...
    fun buildRetrofitClient(token: String?) {
        ...
        if (BuildConfig.DEBUG) {
            ...
            builder.addInterceptor(ChuckInterceptor(Jajanin.getApp()))
        }
